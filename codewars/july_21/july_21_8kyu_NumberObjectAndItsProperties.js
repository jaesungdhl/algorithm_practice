...
function whatNumberIsIt(n){
    let numType = Number(n).toString();
    return `Input number is ${
      numType == "Infinity" ? "Number.POSITIVE_INFINITY" :
      numType == "-Infinity" ? "Number.NEGATIVE_INFINITY" :
      numType == "NaN" ? "Number.NaN" :
      numType == "5e-324" ? "Number.MIN_VALUE" :
      numType == "1.7976931348623157e+308" ? "Number.MAX_VALUE" :
      n}`;
  }
