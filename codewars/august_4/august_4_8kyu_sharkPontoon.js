...
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin){
    let timeToSafety = 0;
    if(dolphin) timeToSafety = (pontoonDistance / youSpeed) / 2;
    else timeToSafety = pontoonDistance / youSpeed;
    let timeToEat = sharkDistance / sharkSpeed;
    return timeToSafety < timeToEat ? "Alive!" : "Shark Bait!";
  }
