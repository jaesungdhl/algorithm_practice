...
function solution(number){
    let solutionArr = [0,0,0];
    for(let i = 1 ; i < number ; i++) {
      if(Number.isInteger(i / 3) && !Number.isInteger(i / 5)) solutionArr[0]++;
      if(!Number.isInteger(i / 3) && Number.isInteger(i / 5)) solutionArr[1]++;
      if(Number.isInteger(i / 3) && Number.isInteger(i / 5)) solutionArr[2]++;
    }
    return solutionArr;
  }
